# Sunshine Client 0.2.1 兼容边界

当前正式版本为 `0.2.1`，支持 Windows x64、Linux x64 和 macOS Apple Silicon。部署时同时核对版本、源码
...
0.2.1 不读取旧 Bootstrap、旧协议身份或旧任务作为兼容输入，也不自动降级。部署 0.2.1 前停止旧服务、
